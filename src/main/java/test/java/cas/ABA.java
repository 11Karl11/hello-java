...
public class ABA {
    ...
    AtomicStampedReference<String> a2 = new AtomicStampedReference<String>("10.0", 0);
    ...
    class Thread3 extends Thread {
        ...
        public void run() {
            ...
            a2.compareAndSet("10.0", "11.0", stamp, stamp + 1);
            stamp = a2.getStamp();
            a2.compareAndSet("11.0", "10.0", stamp, stamp + 1);
        }
    }
    class Thread4 extends Thread {
        ...
        public void run() {
            ...
            System.out.println("AtomicStampedReference原子操作:" + a2.compareAndSet("10.0", "11.0", stamp, stamp + 1));
        }
    }
}
