package test.java.reflect;
import java.lang.reflect.Constructor;

import test.java.annotation.Configuration;
...
public class TestReflect01 {
	...
	public static void main(String[] args)throws Exception {
		...
		String file="test/java/reflect/DataSourceConfig.class";
		...
		//2.将类加载到内存
		Class<?> c1=Class.forName(pkgClass);//test.java.reflect.DataSourceConfig
		//3.判定此类上是否有注解Configuration
		boolean flag=
